...
export default function UserPostComment(props: UserPostCommentProps) {
  ...
  const PUBLISH_COMMENT = gql`
    mutation updatePosts( $id : ID = ${JSON.stringify(
      props.postId
    ...
    user._id
        ...
        updatePosts(
            where: {id:$id}
            create: {comments: {node: {content: $content, imageURL: $imageURL, author: {connect: {where: {node: {_id: $userId}}}}}}}
